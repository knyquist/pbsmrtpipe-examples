...
def _plot_accuracy_distribution(dsets_kpis):
    ...
    fig['layout']['xaxis']['tickfont'].update(size=20)
    fig['layout']['xaxis']['titlefont'].update(size=20)
    fig['layout']['yaxis'].update(title='density')
    fig['layout']['yaxis']['tickfont'].update(size=20)
    fig['layout']['yaxis']['titlefont'].update(size=20)
